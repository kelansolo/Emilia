...
//       system("espeak \"press green to start\" -ven+f4 -s130 -a5 2>/dev/null &");
    ...
    case 10:
      ...
      snprintf(lines[line++], MAX_LEN, "vel=0.5, edger = -1 : dist = 0.5");
      snprintf(lines[line++], MAX_LEN, "vel=0.5, edger = -1 : ir1<0.3");
      snprintf(lines[line++], MAX_LEN, "vel=0.3, edger = -2 : xl>15");
