...
//       system("espeak \"press green to start\" -ven+f4 -s130 -a5 2>/dev/null &");
    ...
    case 10:
      ...
      snprintf(lines[line++], MAX_LEN, "vel=0.1, edger = 0 : time = 0.3");
      ...
      snprintf(lines[line++], MAX_LEN, "servo=3, pservo=-50, vservo=0:time=0.3");
      ...
      snprintf(lines[line++], MAX_LEN, "vel=0.3, tr=0.05: turn=90.0");
